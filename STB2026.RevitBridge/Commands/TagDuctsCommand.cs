    ...
    public class TagDuctsCommand : IExternalCommand
    {
            ...
            ElementSet elements)
        {
            try
            {
                ...
                {
                    TaskDialog.Show("STB2026", "Маркировка доступна только на планах, разрезах и фасадах.");
                    return Result.Cancelled;
                }

                var service = new STB2026.RevitBridge.Services.DuctTaggerService(doc, view);
